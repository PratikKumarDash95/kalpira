      ...
      <section className="surface overflow-hidden rounded-3xl">
            ...
            />
              <button
                ...
                className="absolute bottom-4 right-4 inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 disabled:opacity-60"
              >
          ...
          <div className="px-5 pb-6 sm:px-8 sm:pb-8">
            <div className="-mt-14 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
              <div className="flex items-end gap-4">
                <div className="relative h-28 w-28 overflow-hidden rounded-3xl border-4 border-white bg-white shadow-[0_18px_40px_rgba(234,179,8,0.28)]">
                  {avatarUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                  ...
                  <button
                    ...
                    disabled={uploading !== null}
                    className="absolute inset-x-2 bottom-2 inline-flex items-center justify-center gap-1 rounded-xl bg-slate-900/85 px-2 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-slate-900 disabled:opacity-60"
                  >
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-white/80 px-4 py-3 text-sm text-slate-900 outline-none focus:border-brand-300 focus:ring-2 focus:ring-brand-200"
                    />
                  </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <button
                      onClick={() => avatarInputRef.current?.click()}
                      disabled={uploading !== null}
                      className="inline-flex items-center justify-center gap-2 rounded-xl border border-brand-200 bg-brand-50 px-4 py-3 text-sm font-semibold text-brand-700 hover:bg-brand-100 disabled:opacity-60"
                    >
                ...
                <div className="mt-4 space-y-3 text-sm">
                  {!isInterviewerProfile && (
                    ...
                    >
                      ...
                      <span className="text-brand-700">Manage plan &amp; usage</span>
                    </button>
                  )}
                  {isInterviewerProfile && (
                    <div className="flex items-center justify-between rounded-xl bg-white/70 px-3 py-2">
                      ...
                      <span className="text-brand-700">Interviewer</span>
                    </div>
                  )}
                  <div className="flex items-center justify-between rounded-xl bg-white/70 px-3 py-2">
                    <span className="text-slate-600">Supabase media</span>
                    <span className="text-brand-700">Uploads enabled</span>
                  </div>
                </div>
              </div>
            </div>
