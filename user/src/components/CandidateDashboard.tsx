    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative max-w-5xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button onClick={handleLogout} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-slate-200 text-sm transition-colors border border-slate-700">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <div className="grid gap-2 text-sm text-slate-500">
                      <div className="flex items-center gap-2">
                        <Users size={14} />
                        <span>Interviewer: {session.interviewerName}{session.interviewerEmail ? ` (${session.interviewerEmail})` : ''}</span>
                      </div>
                      {session.topic && (
                        <div className="flex items-center gap-2">
                          <Briefcase size={14} />
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-500 text-white rounded-xl text-sm font-medium transition-colors md:w-auto"
                  >
