...
export async function GET(request: Request) {
  try {
    ...
    cookieStore.set('google_interviewer_oauth_state', state, getOauthStateCookieOptions());
    cookieStore.set('google_interviewer_oauth_code_verifier', codeVerifier, getOauthStateCookieOptions());
