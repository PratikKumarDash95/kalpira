...
const config: Config = {
  content: [
    ...
    // The interviewer portal renders the sibling user app's components
    // through its "@/*" -> "../user/src/*" alias; scan them so their
    // Tailwind classes (incl. the brand scale) are generated here too.
